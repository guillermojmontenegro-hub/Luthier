...
def render_markdown(report: dict) -> str:
    ...
    lines = [
        ...
        f"- LLM model: `{report['summary'].get('llm_model', '')}`",
        f"- LLM harness: `{report['summary'].get('llm_harness', '')}`",
...
def render_summary(report: dict) -> str:
    ...
    lines = [
        ...
        f"llm_model={report['summary'].get('llm_model', '')}",
        f"llm_harness={report['summary'].get('llm_harness', '')}",
